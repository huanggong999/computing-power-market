  ...
  <div class="table-box">
    ...
    >
      <template #tableHeader>
        <el-button @click="openPopover('add', { productType: 2 })">
          新增
        </el-button>
      </template>
...
<script setup lang="ts" name="SelfBuiltComputeServer">
import { enumType } from "@/utils/Enum";
import SelectCloudServer from "../computingPowerServer/components/SelectCloudServer.vue";
