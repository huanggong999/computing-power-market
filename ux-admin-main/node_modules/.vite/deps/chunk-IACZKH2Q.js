import {
  ...
  watchEffect,
  withDirectives
} from "./chunk-I6JCTMLR.js";

// node_modules/.pnpm/@form-create+element-ui@3.2.17_vue@3.5.12_typescript@5.4.5_/node_modules/@form-create/element-ui/dist/form-create.esm.js
  ...
  return defineComponent({
    ...
    setup: function setup4(props) {
      ...
      watch(modelValue5, function(n) {
        if (JSON.stringify(n || {}) === data5.updateValue) return;
...
function Api(h2) {
  ...
  var api = {
    ...
    method: function method(id2, name2) {
      var el = api.el(id2);
      if (!el || !el[name2]) throw new Error(format("err", "".concat(name2, " 方法不存在")));
      return function() {
...
@form-create/element-ui/dist/form-create.esm.js:
  (*!
   * @form-create/element-ui v3.2.17
   * (c) 2018-2025 xaboy
   * Github https://github.com/xaboy/form-create
   * Released under the MIT License.
   *)
*/
//# sourceMappingURL=chunk-IACZKH2Q.js.map
