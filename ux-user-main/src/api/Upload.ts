...
export const UploadFn = (data: FormData): Res<any> =>
  request.post('/file/upload', data, {
    headers: {
      ['Content-Type']: 'multipart/form-data',
    },
  })
export const UploadOcrFn = (data: FormData): Res<string> =>
  request.post('/file/uploadocr', data, {
    headers: {
      ['Content-Type']: 'multipart/form-data',
    },
  })
// 上传身份证
export const UploadIdCardFn = (data: FormData): Res<string> =>
  request.post('/file/uploadIdCardOcr', data, {
    headers: {
      ['Content-Type']: 'multipart/form-data',
    },
  })
