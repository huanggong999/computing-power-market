  ...
  <div class="application-detail">
    ...
    <div style="width: 74%">
      <el-breadcrumb :separator-icon="ArrowRight">
        <el-breadcrumb-item :to="{ path: '/application' }">应用</el-breadcrumb-item>
      ...
      <div class="right">
        ...
        <div class="specification card">
          ...
          <div class="section">
            ...
            <el-select v-model="version" style="width: 322px" size="large" placeholder="请选择版本">
              <el-option v-for="item in [detail.version]" :key="item" :label="item" :value="item" />
            </el-select>
          </div>
          <div class="section">
...
import { detailApplyAPI } from '@/api/application'
...
const getApplication = async (id: number) => {
  let { data } = await detailApplyAPI(id)
