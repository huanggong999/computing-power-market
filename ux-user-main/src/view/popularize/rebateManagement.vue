    ...
    <div class="card">
      ...
      <div class="section-bar flx-align-center">
        <el-form :inline="true" :model="searchForm" class="flx-align-center">
          ...
          <el-form-item label="关联日期" clearable>
            <el-date-picker
              v-model="pickerValue"
              is-range
              type="daterange"
          ...
          <!-- <el-form-item>
            <el-radio-group v-model="searchForm.time">
              ...
              <el-radio-button :value="4">3个月</el-radio-button>
            </el-radio-group>
          </el-form-item> -->
          <el-form-item>
            <div class="btns">
          ...
          <el-form-item class="data"> </el-form-item>
        </el-form>
      </div>
      ...
      >
        ...
        <template #firstRate="row">
          <div>{{ row.firstRate }}%</div>
        </template>
        <template #level="row">
...
const columns: ColumnProps[] = [
  { label: "用户ID/key", prop: "firstUserId" },
...
const { tableData, pageData, getList, searchFn, searchParam } = useTable({
  requestApi: getExtendOrderListApi,
  requestAuto: false,
});
const searchFunc = () => {
