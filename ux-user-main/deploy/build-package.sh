...
#
# 产出: ux-user-main-deploy-YYYYMMDD-HHMM.tgz (放在项目根目录)
...
elif [ -f "${PROJECT_ROOT}/DEPLOYMENT-ux-user-main.md" ]; then
  cp "${PROJECT_ROOT}/DEPLOYMENT-ux-user-main.md" "${OUT_DIR}/DEPLOYMENT-ux-user-main.md"
fi
