...
//        System.out.println(signFlowId);
    ...
    public static final String CopieAccount = "14736398065";
     ...
     */
    public static EsignHttpResponse createByFile(SysContract contract, String notifyUrl) throws EsignDemoException {
        ...
        String jsonParm = "{\n" +
                ...
                "            },\n" +
                "            \"psnSignerInfo\":{\n" +
                "                    \"psnAccount\":"+contract.getClientContactPhone()+",\n" +
                "                     \"psnInfo\": {\n" +
                "                        \"psnName\": \""+contract.getClientName()+"\"\n" +
                "                    }\n" +
                "            },\n" +
                "            \"signConfig\": {\n" +
                "                \"signOrder\": 1\n" +
                ...
                "            \"signFields\": [\n" +
                "                {\n" +
                "                    \"customBizNum\": \""+contract.getContractNo()+"\",\n" +
                "                    \"fileId\": \""+contract.getFileId()+"\",\n" +
     ...
     * @throws EsignDemoException
     */
    public static EsignHttpResponse createCreditByFile(SysCreditContract contract, String notifyUrl) throws EsignDemoException {
        String apiaddr = "/v3/sign-flow/create-by-file";
        //请求参数body体,json格式。get或者delete请求时jsonString传空json:"{}"或者null
        String jsonParm = "{\n" +
                "    \"docs\": [\n" +
                ...
                "                    \"psnAccount\":"+contract.getClientContactPhone()+",\n" +
                "                     \"psnInfo\": {\n" +
                "                        \"psnName\": \""+contract.getClientContactPerson()+"\"\n" +
                "                    }\n" +
                "            },\n" +
                "            \"signConfig\": {\n" +
                "                \"signOrder\": 1\n" +
    ...
    public static EsignHttpResponse createCompanyCreditByFile(SysCreditContract contract, String notifyUrl) throws EsignDemoException {
        String apiaddr = "/v3/sign-flow/create-by-file";
        //请求参数body体,json格式。get或者delete请求时jsonString传空json:"{}"或者null
        String jsonParm = "{\n" +
                "    \"docs\": [\n" +
                ...
                "            },\n" +
                "            \"orgSignerInfo\":{\n" +
                "                    \"orgName\":\""+contract.getClientContactPerson()+"\",\n" +
                "                     \"transactorInfo\": {\n" +
                "                        \"psnAccount\": \""+contract.getClientContactPhone()+"\",\n" +
                "            \"psnInfo\": {\n" +
                "                \"psnName\": \""+contract.getClientContactPersonName()+"\"\n" +
                "            }\n" +
                "                    }\n" +
                "            },\n" +
                "            \"signConfig\": {\n" +
    ...
    public static EsignHttpResponse createCompanyByFile(SysContract contract, String notifyUrl) throws EsignDemoException {
        String apiaddr = "/v3/sign-flow/create-by-file";
        //请求参数body体,json格式。get或者delete请求时jsonString传空json:"{}"或者null
        String jsonParm = "{\n" +
                "    \"docs\": [\n" +
                ...
                "            },\n" +
                "            \"orgSignerInfo\":{\n" +
                "                    \"orgName\":\""+contract.getClientName()+"\",\n" +
                "                     \"transactorInfo\": {\n" +
                "                        \"psnAccount\": \""+contract.getClientContactPhone()+"\",\n" +
                            "            \"psnInfo\": {\n" +
                            "                \"psnName\": \""+contract.getClientContactPerson()+"\"\n" +
     ...
     * @throws EsignDemoException
     */
    public static EsignHttpResponse revoke(String signFlowId) throws EsignDemoException {
